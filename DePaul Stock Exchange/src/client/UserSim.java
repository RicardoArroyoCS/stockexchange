...
public class UserSim implements Runnable {
    ...
    private void makeOrderCancel() throws Exception {
        ...
        user.submitOrderCancel(order.getSymbol(), order.getSide(), order.getId());
        orderCxlCount++;
    }
